...
<div class="container-fluid">
    ...
    <nav class="navbar bg-dark justify-content-between">
        <div class="col">
            <div class="row">
                <h4>My Rental Space</h4>
            </div>
        </div>
        <div class="col col-md-3 col-xl-3 mr-auto float-right">/home</div>
    </nav>

    <!--countries and search box nav-->
                ...
                <div class="row">
                    ...
                    <div class="house col col-md-4">
                        <div class="card p-1 m-1" style="width: auto; max-width:18rem;">
                            ...
                            {{-- <img src="https://storage.googleapis.com/dukaverse-e4f47.appspot.com/app/noprofile.png" class="card-img-top" alt="...">  --}}
                            <div class="card-body">
