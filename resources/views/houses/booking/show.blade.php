                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="d-grid gap-2 mt-1">
                                <a href="#" class="btn btn-success" onclick="sendhouse_book_form()" type="button"><Strong>Book Now</Strong></a>
                            </div>
                        ...
                        <div class="col">
                            <div class="d-grid gap-2 mt-1">
                                <a href="{{ route('welcome') }}" class="btn btn-danger" type="button"><Strong>Cancel</Strong></a>
                            </div>
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 text-center mb-2">
                                                    <ul class="list-inline mb-4" id="portfolio-flters">
                                                        ...
                                                        <li class="btn btn-secondary m-1 " data-filter=".{{ $housedata['house']->house_id.$housedata['house']->id.'inside' }}">Inside </li>
                                                        <li class="btn btn-secondary m-1" data-filter=".{{ $housedata['house']->house_id.$housedata['house']->id.'outside' }}">Outside</li>
                                                    </ul>
                                                </div>
                                            </div>
