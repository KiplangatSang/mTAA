...
@section('content')
				...
				<section class="login-content ">
								...
								<div class="register-box p-3 m-2">
												...
												<form class="register-form" method="POST" action="{{ route('register') }}"
																				...
																				<div class="row form-group">
																								<div class="col-md-6  col-xl-4">
																												<div class="form-outline">
																																...
																																<select type="select" id="user-countryselect"
																								...
																								<div class="col-md-6  col-xl-4">
																												...
																												<input type="city" id="user-city" class="form-control form-control-lg " name="city"
																...
																<div class="form-outline mb-2">
																				...
																				<input type="code" id="user-code" class="form-control form-control-lg  code" name="code"
																...
																<div class="form-check">
																				...
																				@if (session()->has('terms_and_conditions'))
																								<input class="form-check-input me-2 @error('terms_and_conditions') is-invalid @enderror"
																												type="checkbox" value="Accepted"  name="terms_and_conditions"
																												checked />
																				@else
																								<input class="form-check-input me-2 @error('terms_and_conditions') is-invalid @enderror"
																												type="checkbox" value="Accepted" id="user-terms_and_conditions" name="terms_and_conditions" />
																				@endif
												...
												<form class="landlord-form bg-secondary" method="POST" action="{{ route('register') }}"
																enctype="application/x-www-form-urlencoded" id="second-registration-form">
																@csrf
																<div class="row">
																				<div class="col">
																								<h4 class="text-uppercase mb-5 login-head"><i
																																class="fa fa-lg fa-fw fa fa-user-circle-o"></i>Create Landlord account</h4>
																				</div>
																				<div class="col">
																								<div class="float-right m-2">
																												<!--<p class="semibold-text mb-2"><a href="#" data-toggle="flip">Forgot Password ?</a></p>-->
																...
																<div class="form-outline mb-2 ">
																				<div class="row">
																								<div class=" col-md-6 col-xl">
																												<label class="form-label" for="firstname">Your first name</label>
																												<input type="text" id="second-firstname"
																																class="form-control form-control-lg  @error('firstname') is-invalid @enderror"
																																name="firstname" value="{{ old('firstname') }}" required autocomplete="firstname"
																																autofocus />
																												@error('firstname')
																								...
																								<div class=" col-md-6 col-xl">
																												...
																												<input type="text" id="second-lastname"
																																class="form-control form-control-lg  @error('lastname') is-invalid @enderror"
																																name="lastname" value="{{ old('lastname') }}" required autocomplete="lastname" />
																												@error('lastname')
																																<span class="invalid-feedback" role="alert">
																...
																<div class="form-outline mb-2 ">
																				<div class="row form-group">
																								<div class="col-md-6  col-xl-4">
																												<div class="form-outline">
																																<label class="form-label" for="country">Country</label>
																																<select type="select" id="second-countryselect"
																																				class="form-control form-control-lg  @error('country') is-invalid @enderror"
																																				name="country" value="{{ old('country') }}" required autocomplete="country"
																																				autofocus>
																																				<option value="{{ $region['countryName'] ?? '' }}">
																																								{{ $region['countryName'] ?? '' }}
																																				</option>
																																				@foreach ($region['countries'] as $country)
																																								<option value="{{ $country['name'] }}">{{ $country['name'] }}</option>
																								...
																								<div class="col-md-6  col-xl-4">
																												<label class="form-label" for="city">City</label>
																												<input type="city" id="second-city" class="form-control form-control-lg " name="city"
																																value="{{ $region['cityName'] ?? 'unknown' }}" required autocomplete="city" />
																								</div>
																				</div>
																</div>
																<div class="form-outline mb-2">
																				<label class="form-label" for="code ">Code</label>
																				<input type="code" id="second-code" class="form-control form-control-lg  code" name="code"
																								value="{{ $region['countryCode'] ?? 'unknown' }}" required autocomplete="{{ old('code') }}"
																								disabled />
																</div>
																<div class="form-outline mb-2">
																				<div class="row">
																								<div class="col-xl-2 col-md-6 col-sm-4">
																												<label class="form-label" for="phoneCode">Phone Code</label>
																												<input type="code" class="form-control form-control-lg phonecode phonecode" name="phone_code"
																																value="+{{ $region['phoneCode'] ?? '254' }}" required autocomplete="phoneCode"
																																id="second-phonecode" disabled />
																								</div>
																								<div class="col-xl col-md-6 col-sm">
																												<label class="form-label" for="phoneno">Your Phone Number</label>
																												<input id="second-phoneno" type="number"
																																class="form-control form-control-lg  @error('phoneno') is-invalid @enderror"
																																name="phoneno" value="{{ old('phoneno') }}" required autocomplete="phoneno"
																																maxlength="10" />
																												@error('phoneno')
																...
																<div class="form-outline mb-2">
																				...
																				<input type="password" id="second-password-confirm" class="form-control form-control-lg"
																								name="password_confirmation" required autocomplete="new-password" />
																...
																<div class="form-check">
																				...
																				@else
																								<input class="form-check-input me-2 @error('terms_and_conditions') is-invalid @enderror"
																												type="checkbox" value="Accepted" id="second-terms_and_conditions" name="terms_and_conditions" />
																				@endif
																...
																<div class="d-flex justify-content-center mt-2">
																				<button type="submit"
																								class="btn btn-outline-info btn-block btn-lg gradient-custom-4 ">{{ __('Register') }}</button>
																</div>
																<p class="text-center  mt-2">Have already an account? <a href="{{ route('login') }}"
																								class="fw-bold text-body"><u>Login here</u></a></p>
								...
								<script>
												...
												$('#second-countryselect').on('change', function() {
																var filter = $('#second-countryselect').find(":selected").val();
																var codes = searchCode(filter);

												});
												$('#user-countryselect').on('change', function() {
																var filter = $('#user-countryselect').find(":selected").val();
																var codes = searchCode(filter);
												});

												function searchCode(filter) {
																var countryarray = @json($region['countries']);
																var codes = null;

																for (var i = 0; i < countryarray.length; i++) {
																				if (countryarray[i]["name"] == filter) {
																								var phonecode = "+" + countryarray[i]['phonecode']
																								var code = countryarray[i]['iso3'];
																								codes = new Array(phonecode, code)
																				}
																}
                                                                $('.phonecode').val(codes[0]);
																$('.code').val(codes[1]);
																return codes;
												}
								</script>
