...
class CountriesListSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('countries_lists')->delete();
        ...
        $countries = array(
            ...
            array('id' => '226', 'iso' => 'US', 'name' => 'UNITED STATES', 'nicename' => 'United States of America', 'iso3' => 'USA', 'numcode' => '840', 'phonecode' => '1'),
        ...
        DB::table('countries_lists')->insert($countries);
